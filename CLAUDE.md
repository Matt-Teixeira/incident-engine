...
> **On the fleet dev/release paradigm since 2026-08-26** (third app, after
> data_acquisition and monday). Conventions: `data_acquisition/docs/migration_CLAUDE.md`
> Part 1. Editable clone: `~/apps/incident-engine`; `/opt/apps/incident-engine` is
> release output produced ONLY by `build-release.sh`. Migration record:
> `markdown/PHASE_LOG.md` ("Infra — Migration to the fleet dev/release paradigm").
